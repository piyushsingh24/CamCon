  ...
  return (
    <div className="p-4 space-y-6 max-w-4xl mx-auto">
      <Card className="shadow-lg border border-gray-200 rounded-2xl">
        <CardHeader>
          <CardTitle className="text-xl font-semibold text-gray-800">Profile Details</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-6">
              <img
                src={profile.image || `https://api.dicebear.com/7.x/initials/svg?seed=${profile.name || "U"}`}
                alt="Profile"
              ...
              <div>
                <label
                  ...
                  className="cursor-pointer inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium bg-white text-gray-700 hover:bg-gray-100"
                >
                  Upload Photo
                </label>
                <input
              ...
              {editField === "phone" ? (
                phoneStep === "verify_current" ? (
                  ...
                  <>
                    ...
                    />
                    <Button onClick={() => {
                      if (newPhone.length < 10) return alert("Invalid phone number");
                ...
                <div className="flex items-center justify-between w-full md:w-auto px-3 py-2 border rounded text-sm bg-gray-50 text-gray-600">
                  {profile.phone}
                  <Button
                    type="button"
                    size="icon"
